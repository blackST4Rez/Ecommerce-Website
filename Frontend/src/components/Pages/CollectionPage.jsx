    ...
    return (
        <div className="flex flex-col lg:flex-row" >
            ...
            <button
                ...
                <BiFilter size={25} className="text-white" /><span className="text-white" >Filters</span>
            </button>
            {/* Filter Sidebar */}
            <div
                ref={sidebarRef}
                className={`${isSidebarOpen
                    ? "translate-x-0"
                    : "-translate-x-full"
                }fixed inset-y-0 z-50 left-0 w-64 overflow-y-auto transition-transform duration-300 kg:static lg:translate-x-0`}
            >
                <FilterSiderbar />
            </div>
            <div className="grow p-4">
                <h2 className="text-2xl uppercase mb-4 text-[#CB2957] font-medium">All Collection</h2>
                {/* Sort Options */}
                <SortOptions />
                {/* Product Grid */}
