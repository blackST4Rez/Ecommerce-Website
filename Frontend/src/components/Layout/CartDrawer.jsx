...
const CartDrawer = ({
    ...
    return (
        <div className={`fixed top-0 right-0 w-/4 sm:w-1/2 md:w-120 h-full bg-black transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
