        ...
        <div className='bg-black text-[#CB2957]'>
            <div className='container mx-auto flex justify-between items-center py-3'>
                <div className='hidden md:flex items-center space-x-5'>
                    <a href="" className='text-white hover:text-[#CB2957] transition-all ease-in-out duration-300' >
                ...
                <div className="text-l hidden md:block">
                    <a href="" className='text-white hover:text-[#CB2957] transition-all ease-in-out duration-300'>+977 98 0329 4610</a>
                </div>
            </div>
        </div>
    )
